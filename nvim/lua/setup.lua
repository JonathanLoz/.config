local setup = {
	...
	search_dirs = {
		...
		"~/Google Drive/My Drive/Computational Projects",
	},
	...
	obsidian_dirs = {
		templates = "~/Google Drive/My Drive/nocheosfera/templates/", -- point to a templates folder in Your zettelkasten like so: ~/myvaults/mainvault/templates/
		dailynotes = "./daily/", -- point to a daily notes folder in Your zettelkasten like so: ./daily/
		attachments = "assets/", -- point to an assets folder in Your zettelkasten like so: assets/
		generalpath = "~/Google Drive/My Drive/nocheosfera/", --~/myvaults/mainvault/
		mainnotes = "~/Google Drive/My Drive/nocheosfera/notes/", -- This direction specifies what is the main folder for Your notes. This information is used in dashboard - to pick a random note from Your main notes.
	},
	chat_dir = "~/Google Drive/My Drive/nocheosfera/chat/", -- This folder can be anywhere in the filesystem. I just happen to want to have my LLM chats inside zettelkasten, so I can reference to them anytime I want.
}
